...
const createService = (id, name, category, duration_minutes, price, description) => ({
  id,
  name,
  category,
  duration_minutes,
...
const staff = [
  { id: "stf001", name: "Hoang Duy", role: "Staff", bio: "Available for customer bookings and salon appointments.", image_url: "", is_active: true },
  { id: "andy", name: "andy", role: "Nail Technician", bio: "Experienced in everyday nail care and guest-friendly appointments.", image_url: "", is_active: true },
  { id: "emily", name: "EMILY", role: "Nail Technician", bio: "Focused on clean finishes, efficient service, and polished results.", image_url: "", is_active: true },
  { id: "helen", name: "HELEN", role: "Senior Technician", bio: "Known for steady technique and a calm, detail-oriented approach.", image_url: "", is_active: true },
  { id: "lacci", name: "LACCI", role: "Nail Technician", bio: "Helps guests choose combinations that fit both style and schedule.", image_url: "", is_active: true },
  { id: "lilly", name: "LILLY", role: "Nail Technician", bio: "Brings a warm touch to manicure, pedicure, and add-on services.", image_url: "", is_active: true },
];
...
const featuredDates = Array.from({ length: 5 }, (_, index) =>
